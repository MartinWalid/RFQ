      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm dark:shadow-black/20 border border-slate-200 dark:border-slate-700 overflow-hidden">
          <div className="px-6 py-4 border-b border-slate-100 dark:border-slate-700">
            <h2 className="text-base font-semibold text-slate-800 dark:text-slate-200">Request Details</h2>
          </div>
          ...
          <div className="px-6 py-5 grid md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <select
                ...
                className="w-full border border-slate-200 dark:border-slate-700 rounded-lg px-3 py-2 text-sm bg-white dark:bg-slate-700 text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition cursor-pointer"
              >
            ...
            <div>
              <label className="block mb-1.5 text-sm font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide">
                Quotation Deadline <span className="text-red-500 dark:text-red-400">*</span>
              </label>
              <input
                type="datetime-local"
                min={today}
                ...
                className="w-full border border-slate-200 dark:border-slate-700 rounded-lg px-3 py-2 text-sm bg-white dark:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition"
              />
            </div>

            <div>
              <label className="block mb-1.5 text-sm font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide">
                Request Delivery Date <span className="text-red-500 dark:text-red-400">*</span>
              </label>
              <input
                type="datetime-local"
            ...
            <div>
              <label className="block mb-1.5 text-sm font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide">
                Payment Terms <span className="text-red-500 dark:text-red-400">*</span>
              </label>
              <select
                value={paymentTerms}
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm dark:shadow-black/20 border border-slate-200 dark:border-slate-700 overflow-hidden">
          <div className="px-6 py-4 border-b border-slate-100 dark:border-slate-700">
            <h2 className="text-base font-semibold text-slate-800 dark:text-slate-200">
              Items &amp; Quantities <span className="text-red-500 dark:text-red-400">*</span>
            </h2>
          </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead className="bg-slate-50 dark:bg-slate-700/30 border-b border-slate-200 dark:border-slate-700 text-left">
                <tr>
                  <th className="px-5 py-3 text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wide w-10">#</th>
                  <th className="px-4 py-3 text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide w-32">
                    Quantity <span className="text-red-400 dark:text-red-400">*</span>
                  </th>
                  <th className="px-4 py-3 text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide">
                    Specifications <span className="text-red-400 dark:text-red-400">*</span>
                  </th>
              ...
              <tbody className="divide-y divide-slate-100 dark:divide-slate-700">
                {items.map((item, index) => (
                  <tr key={index} className="hover:bg-slate-50/40 transition-colors">
                    ...
                    <td className="px-5 py-3 text-slate-400 dark:text-slate-500 text-center text-xs font-medium">{index + 1}</td>
                    ...
                    <td className="px-4 py-3">
                      <input
                        ...
                        className="w-full border border-slate-200 dark:border-slate-700 rounded-lg px-3 py-2 text-sm placeholder-slate-300 dark:placeholder-slate-500 bg-white dark:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition"
                      />
                    </td>
                    ...
                    <td className="px-4 py-3">
                      <label className="flex items-center gap-2 bg-slate-50 dark:bg-slate-700/30 border border-slate-200 dark:border-slate-700 rounded-lg px-3 py-2 cursor-pointer hover:bg-blue-50 dark:hover:bg-blue-900/30 hover:border-blue-300 dark:hover:border-blue-500 transition min-w-[160px]">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-3.5 h-3.5 text-slate-400 dark:text-slate-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="px-6 py-4 border-t border-slate-100 dark:border-slate-700">
            <button
              ...
              className="flex items-center gap-2 text-sm font-semibold text-blue-600 dark:text-blue-400 hover:text-blue-700 border border-dashed border-blue-300 dark:border-blue-700 hover:border-blue-500 dark:hover:border-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/30 rounded-lg px-4 py-2 transition-all"
            >
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 px-6 py-4 bg-slate-50 dark:bg-slate-700/30 border-t border-slate-200 dark:border-slate-700">
            <div className="flex items-center gap-4 flex-wrap">
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="border border-slate-200 dark:border-slate-700 rounded-lg px-3 py-2 text-sm text-slate-700 dark:text-slate-300 placeholder-slate-300 dark:placeholder-slate-500 bg-white dark:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition w-52"
            ...
            <button
              ...
              disabled={loading}
              className="flex items-center gap-2 px-6 py-2.5 rounded-xl text-sm font-bold bg-blue-700 dark:bg-blue-600 hover:bg-blue-800 dark:hover:bg-blue-700 active:bg-blue-900 dark:active:bg-blue-800 text-white shadow-md shadow-blue-200 dark:shadow-blue-900/30 transition-all"
            >
